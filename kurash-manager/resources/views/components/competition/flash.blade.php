...
@if (session('status'))
    <div class="flex items-start gap-2.5 rounded-md bg-brand-soft px-4 py-3 text-[13.5px] font-medium text-brand-deep dark:text-brand-300">
...
@if (session('error'))
    <div class="flex items-start gap-2.5 rounded-md bg-danger-soft px-4 py-3 text-[13.5px] font-medium text-danger dark:text-danger-200">
