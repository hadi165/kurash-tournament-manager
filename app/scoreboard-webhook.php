...
$expectedToken = getenv('SCOREBOARD_WEBHOOK_SECRET') ?: '';
$providedToken = $_SERVER['HTTP_X_SCOREBOARD_TOKEN'] ?? '';

// Fail closed. The old fallback of 'CHANGE_ME' meant that forgetting to set the
// secret left the endpoint open to anyone who read this file on GitHub.
if ($expectedToken === '') {
    error_log('scoreboard-webhook: SCOREBOARD_WEBHOOK_SECRET is not set — refusing all requests.');
